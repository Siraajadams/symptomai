...
export default function Home() {
  ...
  function updateCountry(country: string) {
    setForm((prev) => ({
      ...prev,
      country,
      dialCode: country === 'South Africa' ? '+27' : '+44',
    }));
  }
  ...
  const emergencyNumber = form.country === 'South Africa' ? '27823148000' : '447860039092';
  const standardWhatsappUrl = `https://wa.me/?text=${whatsappText}`;
  const emergencyWhatsappUrl = `https://wa.me/${emergencyNumber}?text=${whatsappText}`;
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 20 }}>
            ...
            {result.level === 'DOCTOR_IN_PHARMACY' && (
              <>
                ...
                <a className="button secondary" href={standardWhatsappUrl} target="_blank">
        ...
        <>
          <section className="hero">
            ...
            <div className="card">
              ...
              <p>Safe red-flag triage, referral support, and Supabase analytics.</p>
            </div>
          </section>
          ...
          <div id="triage" className="card" style={{ marginTop: 24 }}>
            ...
            <div className="grid">
              ...
              <label>
                Age
                <input className="input" type="number" value={form.age} onChange={(e) => update('age', e.target.value)} placeholder="Auto-calculated" />
              </label>
